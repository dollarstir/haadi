...
- **Artifact uploads:** originals live in `docs/assets/artifactdocs/`. Detail pages link to those files; replace a file in place or update the `href` on the page if you rename it.
